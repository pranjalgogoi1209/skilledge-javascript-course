...
console.log('....'.repeat(3),'PREVIOUS ELEMENT SIBLING PROPERTY','....'.repeat(3));
...
// # CLICK
console.log('....'.repeat(3),'ADD EVENT LISTNER METHOD : CLICK','....'.repeat(3));
...
btn.addEventListener('click', function(){
    ...
    if(count===1){
        console.log('clicked');
        output.firstElementChild.innerText='Congratulationson completing 7 days hard miracle morning challenge';
    }else if(count===2){ 
        console.log('clicked');
        ...
        body.innerHTML='<h1>Congratulations on completing 7 days hard miracle morning challenge</h1>';
    }
});
