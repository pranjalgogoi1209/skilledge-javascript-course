...
function Home(){
    const [blogs, setBlog] = useState([
        ...
        {title : 'book3', body : 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, facilis deleniti laudantium et, architecto sed, commodi iusto doloremque obcaecati corrupti magnam rerum? Recusandae in quia ea nisi, quos aspernatur velit.', author : 'rahul singh', id : 3}
    ]);
