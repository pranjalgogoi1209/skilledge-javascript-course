...
console.log('....'.repeat(3),'document.getElementById();','....'.repeat(3));

var id = document.getElementById('h1_id');
console.log(id);


// # document.getElementsByClassName();
console.log('....'.repeat(3),'document.getElementsByClassName();','....'.repeat(3));

var cls = document.getElementsByClassName('new_class'); //html collection
console.log(cls);
/* console.log(cls[0]);
console.log(cls[1]); */
for(let c of cls){
...
console.log('....'.repeat(3),'document.getElementsByTagName();','....'.repeat(3));
...
console.log('....'.repeat(3),'document.querySelector();','....'.repeat(3));
...
console.log(main1.previousElementSibling.lastElementChild.parentElement.firstElementChild);
...
console.log(main1.nextElementSibling.previousElementSibling.previousElementSibling.nextElementSibling.firstElementChild);


// # another way of grabing element from dom
console.log('....'.repeat(3),'another way of grabing element from dom','....'.repeat(3));

console.log(main1.querySelector('ul'));
console.log(navbar.firstElementChild.parentElement.nextElementSibling.querySelector('p').nextElementSibling);


// # CHECK ATTRIBUTES OF ANY ELEMENT
console.log('....'.repeat(3),'CHECK ATTRIBUTES OF ANY ELEMENT','....'.repeat(3));

console.log(main1.lastElementChild.attributes);


// # SET ATTRIBUTES IN ANY ELEMENT
console.log('....'.repeat(3),'SET ATTRIBUTES IN ANY ELEMENT','....'.repeat(3));
...
console.log('....'.repeat(3),'.getAttribute() : CHECK VALUE OF ANY ATTRIBUTE OF AN ELEMENT','....'.repeat(3));
...
console.log('....'.repeat(3),'CREATE TEXT INSIDE AN ELEMENT','....'.repeat(3));
...
console.log('....'.repeat(3),'INJECTING CUSTOM CREATED HTML ELEMENT NODE INTO DOM','....'.repeat(3));
...
var h4 = document.createElement('h4').innerText = 'I am creater .innerText - One line inside section';
var h5 = document.createElement('h5').innerText = 'I am creater .innerText - Two line inside section';
